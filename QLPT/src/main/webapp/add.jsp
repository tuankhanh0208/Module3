...
<div class="container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/rooms?path=add">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="idRoom"  readonly name="idRoom" required >
<%--            <p class="text-danger">${mess}</p>--%>
        </div>
        <div class="mb-3">
            <label for="username" class="form-label">Tên người thuê</label>
            <input type="text" class="form-control" id="username"  placeholder="Nhập tên người thuê" name="username"  required>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" id="dateStart" name="dateStart" placeholder="Nhập ngày bắt đầu thuê" required>
...
<%--        <p class="text-danger">${mess}</p>--%>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="note" rows="3" name="note" placeholder="Nhập ghi chú của bạn" dirname="note" required></textarea>
